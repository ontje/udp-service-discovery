...
class UDPServiceDiscovery extends events_1.EventEmitter {
    constructor(opts) {
        super();
        this._status = 'INITIALIZING';
        this._serviceListenFor = null;
    ...
    broadcast(name, ip, port, msg, repeat = 0) {
        let service = { host: null };
        let interval;
        let runs = 0;
        let netmask;
        let host;
    ...
    _getBroadcastAddress(sender, ip, netmask) {
        sender._log(ip, netmask);
        const block = new netmask_1.Netmask(ip + '/' + netmask);
        return block.broadcast;
    }
}
exports.UDPServiceDiscovery = UDPServiceDiscovery;
